            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body mt-4 ml-2">
                      <h5 class="card-title text-left"><small><i class="fas fa-user"></i> {{$profile->fname}}&nbsp;{{$profile->lname}}</small></h5>
            ...
            <div class="col-md-8">
                <form class="border px-4 pt-2 pb-3" method="POST" action="{{route('user-profile-update',$profile->id)}}">
                    ...
                    <div class="form-group">
                      ...
                      <input id="inputTitle" type="text" name="name" placeholder="Enter name"  value="{{$profile->fname}}" class="form-control">
                      @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <input id="inputTitle" type="text" name="name" placeholder="Enter name"  value="{{$profile->lname}}" class="form-control">
                        @error('name')
                            <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
