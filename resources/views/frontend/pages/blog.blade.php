                        ...
                        {{-- {{$post}} --}}
                            <div class="col-lg-6 col-md-6 col-12">
                                ...
                                <img src="{{$post->photo}}" alt="{{$post->photo}}">
                                    <div class="content">
                                        <p class="date"><i class="fa fa-calendar" aria-hidden="true"style="color: black;font-family:Myriad Pro;"></i> {{$post->created_at->format('d M, Y. D')}}
                                            <span class="float-right"style="color: balck;font-family:Myriad Pro;">
                                                <i class="fa fa-user" aria-hidden="true"style="color: black;font-family:Myriad Pro;"></i>
                ...
                <div class="col-lg-4 col-12">
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget side-tags">
                            <h3 class="title" style="font-family:Myriad Pro;">Tags</h3>
                            <ul class="tag">
                                @if(!empty($_GET['tag']))
                                    @php
