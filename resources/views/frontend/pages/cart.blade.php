								...
								@if(Helper::getAllProductFromCart())
									@foreach(Helper::getAllProductFromCart() as $key=>$cart)
										<tr>
											...
											@endphp
											<td class="image" data-title="No"><img src="{{$photo[0]}}" class="img-fluid zoom" alt="{{$photo[0]}}"></td>
											<td class="product-des" data-title="Description">
												<p class="product-name"><a href="{{route('product-detail',$cart->product['slug'])}}" target="_blank">{{$cart->product['title']}}</a></p>
												<p class="product-des">{!!($cart['summary']) !!}</p>
											</td>
											<td class="product-des" data-title="Description">
												<p class="product-name"><a href="{{route('product-detail',$cart->product['slug'])}}" target="_blank">{{$cart->product['form']}}</a></p>
												<p class="product-des">{!!($cart['form']) !!}</p>
											</td>
											...
											<td class="qty" data-title="Qty"><!-- Input Order -->
												<div class="input-group">
													...
													<div class="button plus" style="height:70px;">
											...
											<td class="total-amount cart_single_price" data-title="Total"><span class="money">AED. {{number_format($cart['amount'],2)}}</span></td>
					...
					<div class="total-amount">
						<div class="row">
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										<li class="order_subtotal" data-price="{{Helper::totalCartPrice()}}" >Cart Subtotal<span>AED. {{number_format(Helper::totalCartPrice(),2)}}</span></li>
