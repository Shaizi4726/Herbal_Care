      ...
      <ul class="list-main">
        ...
        @auth 
          @if(Auth::user()->role=='admin')
            <li><i class="fa-solid fa-user-tie d-user-icon"></i><a class="user-nav rb" href="{{route('admin')}}"  target="_blank">Dashboard</a></li>
          @else 
            <li><i class="fa-solid fa-user d-user-icon"></i><a class="user-nav rb" href="{{route('user')}}"  target="_blank">Dashboard</a></li>
          @endif
