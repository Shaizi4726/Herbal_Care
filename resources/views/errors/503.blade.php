...
<html lang="en">
<head>
	<title>Maintenance || HerbalCare</title>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
	...
	<link href="{{asset('css/main/maintenance.css')}}" rel="stylesheet">
	<link href="{{asset('css/main/maintenance-responsive.css')}}" rel="stylesheet">
</head>
<body>
