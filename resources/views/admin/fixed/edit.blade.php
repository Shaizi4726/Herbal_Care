...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('fixed-banners.update',$banner_fixed->id)}}">
        @csrf 
        @method('PATCH')
        <div class="form-group">
          ...
          <input id="thumbnail" class="form-control" type="text" name="photo_desktop" value="{{$banner_fixed->photo_desktop}}">
        </div>
        ...
        <div class="form-group">
          ...
          <input id="thumbnail1" class="form-control" type="text" name="photo_tablet" value="{{$banner_fixed->photo_tablet}}">
        </div>
        ...
        <div class="form-group">
          ...
          <input id="thumbnail2" class="form-control" type="text" name="photo_mobile" value="{{$banner_fixed->photo_mobile}}">
        </div>
