...
<!-- fixed Banner -->
    <li class="nav-item">
      ...
      <div id="collapseFixedBanner" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          <h6 class="collapse-header">Banner Options:</h6>
          <a class="collapse-item" href="{{route('fixed-banners.index')}}">Fixed Banners</a>
          <a class="collapse-item" href="{{route('fixed-banners.create')}}">Add Fixed Banners</a>
        </div>
      </div>
    </li>
    <!-- Divider -->
    ...
    <li class="nav-item">
      ...
      <div id="blogCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <a class="collapse-item" href="{{route('blogs.index')}}">Blog</a>
    ...
    <li class="nav-item">
        ...
        <div id="formCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('forms.index')}}">Forms</a>
            <a class="collapse-item" href="{{route('forms.create')}}">Add Form</a>
    ...
    <li class="nav-item">
        ...
        <div id="stateCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('states.create')}}">Add States</a>
          </div>
        </div>
    </li>
    <!-- City -->
