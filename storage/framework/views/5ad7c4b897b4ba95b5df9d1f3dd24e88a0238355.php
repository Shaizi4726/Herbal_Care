...
<html lang="en-us">
  ...
  <body>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-3-typeahead/4.0.1/bootstrap3-typeahead.min.js"></script>
		<script src="<?php echo e(asset('frontend/js/jquery.exzoom.js')); ?>" async></script>
		<script src="<?php echo e(asset('frontend/js/header.js')); ?>"></script>
		<script src="<?php echo e(asset('frontend/js/main.js')); ?>"></script>
		<?php echo $__env->yieldPushContent('scripts'); ?>
		<!-- End Scripts -->
  </body>
</html><?php /**PATH D:\XAMPP\htdocs\herbalcare\resources\views/frontend/layouts/master.blade.php ENDPATH**/ ?>