...
<html>
  <head>
    ...
    <link rel="stylesheet" href="<?php echo e(base_path('public_html/css/main/pdf.min.css')); ?>">
  </head>

  <body>
    <div class="invoice-header">
      <img src="<?php echo e(base_path('public_html/images/sale-order-header.png')); ?>"/>
    </div>
    ...
    <div class="address">
      <div class="billing">
        ...
        <?php endif; ?>
          ...
          <h5>Address: </h5><span class="value"><?php echo e($order->address); ?>, <?php echo e($city->name); ?></span><br/><span class="cty"><?php echo e($city->state->name); ?>, <?php echo e($city->country->name); ?></span><br/>
      </div>
      <div class="shipping">
        <?php 
        ...
        <?php endif; ?>
          ...
          <h5>Address: </h5><span class="value"><?php echo e($order->shipping->address); ?>, <?php echo e($shipping_city->name); ?></span><br/><span class="cty"><?php echo e($shipping_city->state->name); ?>, <?php echo e($shipping_city->country->name); ?></span><br/>
      </div>
    </div>
    ...
    <section class="order-details">
      ...
      <table class="table details-table">
        ...
        ?>
          <tr>
            <td><?php echo e($i); ?></td>
            <td><?php echo e($order_item->attr->product->name); ?></td>
            <?php if($order_item->attr->form): ?>
              <td><?php echo e($order_item->attr->form->name); ?></td>
            <?php endif; ?>
            <?php if($order_item->attr->size): ?>
              <td><?php echo e($order_item->attr->size); ?></td>
            <?php endif; ?>
            <td><?php echo e($order_item->quantity); ?></td>
            <td>AED <?php echo e(number_format($order_item->attr->price,2)); ?></td>
...
<?php /**PATH D:\XAMPP\htdocs\herbalcare\resources\views/main/order/sale-invoice.blade.php ENDPATH**/ ?>